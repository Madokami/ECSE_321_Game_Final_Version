...
public class TimedEvent {
	...
	public void tick(){
		...
		if(System.currentTimeMillis()-startTime>duration){
			...
			else if(eventName.equals("timeStop")){
	...
	/**
	 * commences an event
	 * @param duration time of the event in milliseconds
	 * @param key lets the Class find what events to activate
	 */
	...
	/**
	 * shifts an image by specific height and width
	 * @param image object
	 */
